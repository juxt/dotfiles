if exists('g:juxt_loaded_fzf')
  finish
endif

if !executable('fzf')
  echoerr 'Please install fzf with `sudo pacman -Syu fzf`'
  finish
endif

call juxt#plug#add('junegunn/fzf', {'merged': 0})
call juxt#plug#add('junegunn/fzf.vim')
